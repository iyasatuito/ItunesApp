...
class UpdateFeaturedMoviesUseCase @Inject constructor(threadExecutor: ThreadExecutor, private val repository: ItunesRepository)
    : NewCompletableUseCase<Any?>(threadExecutor) {
    override fun buildUseCaseObservable(params: Any?) =
        run(repository::updateFeaturedMovies)
